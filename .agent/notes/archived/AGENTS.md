...
Run the project's archive workflow and append new artifact hashes with the archive verifier's write mode. The normal verifier rejects changed or missing sealed artifacts, incomplete triplets, unknown kind folders, and invalid archive metadata.
