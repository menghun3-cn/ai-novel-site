...
const STATUS_BY_CODE: Record<CoreErrorCode, number> = {
  ...
  TAG_NOT_FOUND: 404,
  TAG_NAME_TAKEN: 409,
  SHORT_STORY_NOT_FOUND: 404,
  SHORT_STORY_VERSION_NOT_FOUND: 404,
  BATCH_SCHEDULE_NOT_FOUND: 404,
  REVIEW_RULE_NOT_FOUND: 404,
  REVIEW_PROMPT_NOT_FOUND: 404,
  REVIEW_RECORD_NOT_FOUND: 404,
  AI_TASK_NOT_FOUND: 404,
  RULE_VERSION_CONFLICT: 409,
  RULE_VERSION_IMMUTABLE: 409,
  INVALID_RULE_DIMENSIONS: 400,
  STRUCTURED_OUTPUT_FAILED: 502,
  SHORT_STORY_NOT_PUBLISHED: 400,
  PUBLICATION_NOT_FOUND: 404,
  ARC_REVIEW_RECORD_NOT_FOUND: 404,
  CHAPTER_NOT_FOUND_IN_ARC: 400,
  PRODUCTION_LINE_NOT_FOUND: 404,
  PRODUCTION_RUN_NOT_FOUND: 404,
  INVALID_LINE_CONFIG: 400,
  LINE_QUOTA_EXCEEDED: 409,
};
